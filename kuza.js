...
let ownername = '*aryacann!!*' //NAMA OWNER
let owner = '6282172010674' // NOMOR OWNER
let symbol = '*☛*'
let faketeks = `*_XIGA BOTS_*` 
...
const ytabilbotz = "6285717118145@s.whatsapp.net"
const txt = mek.message.conversation
const botNumber = kuza.user.jid
const ownerNumber = [`${owner}@s.whatsapp.net`, `6282172010674@s.whatsapp.net`, `6282172010674@s.whatsapp.net`]
...
const fvn = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6285717118145-1613049930@g.us" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":99999,"ptt": "true"}} }
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "𝑿𝑰𝑮𝑨 𝑩𝑶𝑻𝑺", 'jpegThumbnail': fs.readFileSync('pee.jpg')}}}
...
costum(buffer, sticker, Verived, `𝑿𝑰𝑮𝑨 𝑩𝑶𝑻𝑺`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
